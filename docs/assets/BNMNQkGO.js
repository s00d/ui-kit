...
`,M=a=>(h("data-v-cd30ec63"),a=a(),O(),a),j={class:"value"},G=M(()=>t("strong",null,"Value: ",-1)),H=x({__name:"autosize",setup(a){const n=v("");return(o,l)=>{const d=m;return r(),f(V,null,[e(d,{modelValue:s(n),"onUpdate:modelValue":l[0]||(l[0]=i=>g(n)?n.value=i:null),autosize:""},null,8,["modelValue"]),t("div",j,[G,c(" "+y(JSON.stringify(s(n))),1)])],64)}}}),P=_(H,[["__scopeId","data-v-cd30ec63"]]),K=`<script setup lang="ts">
const val = ref('');
<\/script>
...
`,Q=a=>(h("data-v-cdb1cdc5"),a=a(),O(),a),W={class:"value"},X=Q(()=>t("strong",null,"Value: ",-1)),Y=x({__name:"rows",setup(a){const n=v("");return(o,l)=>{const d=m;return r(),f(V,null,[e(d,{modelValue:s(n),"onUpdate:modelValue":l[0]||(l[0]=i=>g(n)?n.value=i:null),autosize:"",rows:3},null,8,["modelValue"]),t("div",W,[X,c(" "+y(JSON.stringify(s(n))),1)])],64)}}}),Z=_(Y,[["__scopeId","data-v-cdb1cdc5"]]),ee=`<script setup lang="ts">
const val = ref('');
<\/script>
