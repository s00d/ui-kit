import{E as k}from"./Cepu5Cdp.js";import{g as w,J as $,r as u,o as f,c as g,b as n,w as t,ar as V,Y as x,u as o,x as F,d as c,a2 as E,as as C,a as m,t as I,F as S,n as N,p as P,f as q,_ as D,i as W,H as J,h as B,a0 as H,P as M,au as X}from"./C296uaLE.js";import{u as Y}from"./CNmpcN_a.js";const z=p=>(P("data-v-7be322c8"),p=p(),q(),p),A={class:"value"},G=z(()=>m("strong",null,"Value:",-1)),K=w({__name:"basic",setup(p){const a=$({name:"",email:""}),v={name:[s=>s.length>=3||{message:"landing.global.validation.minLength",params:{n:3}}],email:[s=>s.length>=3&&/.+@[^@]+\.[^@]{2,}$/.test(s)||"landing.global.validation.email"]},r=u(),h=()=>{var l;const s=(l=r.value)==null?void 0:l.validate();if(console.dir(s),!s){console.log("Validation error");return}console.log("Form is valid")},_=()=>{a.name="",a.email="",N(()=>{var s;(s=r.value)==null||s.resetValidation()})};return(s,l)=>(f(),g(S,null,[n(C,{ref_key:"formRef",ref:r,model:o(a),rules:v,name:"basic",class:"demo-form",onSubmit:l[2]||(l[2]=E(()=>{},["prevent"]))},{default:t(()=>[n(V,{name:"name",label:"Name"},{default:t(()=>[n(x,{modelValue:o(a).name,"onUpdate:modelValue":l[0]||(l[0]=d=>o(a).name=d)},null,8,["modelValue"])]),_:1}),n(V,{name:"email",label:"Email"},{default:t(()=>[n(x,{modelValue:o(a).email,"onUpdate:modelValue":l[1]||(l[1]=d=>o(a).email=d)},null,8,["modelValue"])]),_:1}),n(V,{class:"actions"},{default:t(()=>[n(F,{type:"primary",onClick:h},{default:t(()=>[c(" Submit ")]),_:1}),n(F,{type:"default",onClick:_},{default:t(()=>[c(" Reset ")]),_:1})]),_:1})]),_:1},8,["model"]),m("div",A,[G,c(" "+I(JSON.stringify(o(a))),1)])],64))}}),Q=D(K,[["__scopeId","data-v-7be322c8"]]),Z=`<script setup lang="ts">
...
`,pn={class:"state"},un={class:"events"},fn=w({__name:"deps",setup(p){const a=$({needle:"",text:""}),v=B(()=>(a.needle,{needle:[e=>e.length>=3||{message:"landing.global.validation.minLength",params:{n:3}}],text:[e=>e.includes(a.needle)||"landing.global.validation.no_needle"]})),r=u(),h=()=>{var i;const e=(i=r.value)==null?void 0:i.validate();if(console.dir(e),!e){console.log("Validation error");return}console.log("Form is valid")},_=()=>{a.needle="",a.text="",N(()=>{var e;(e=r.value)==null||e.resetValidation()})},s=u(null),l=u([]),d=u(!1),L=e=>{d.value=e;const i=new Date().toISOString();l.value.push(`[${i}] isFormValid === ${e}`)},T=e=>{s.value=e;const i=new Date().toISOString();l.value.push(`[${i}] state changed`)};return W(()=>{var e;(e=r.value)==null||e.validate(void 0,!0)}),(e,i)=>{const O=x,y=V,R=H,b=F;return f(),g(S,null,[n(C,{ref_key:"formRef",ref:r,model:o(a),rules:o(v),name:"deps",class:"demo-form",onSubmit:i[2]||(i[2]=E(()=>{},["prevent"])),onValidate:L,onChange:T},{default:t(()=>[n(y,{name:"needle",label:"Needle"},{default:t(()=>[n(O,{modelValue:o(a).needle,"onUpdate:modelValue":i[0]||(i[0]=j=>o(a).needle=j)},null,8,["modelValue"])]),_:1}),n(y,{name:"text",label:"Text"},{default:t(()=>[n(R,{modelValue:o(a).text,"onUpdate:modelValue":i[1]||(i[1]=j=>o(a).text=j)},null,8,["modelValue"])]),_:1}),n(y,{class:"actions"},{default:t(()=>[n(b,{type:"primary",disabled:!o(d),onClick:h},{default:t(()=>[c(" Submit ")]),_:1},8,["disabled"]),n(b,{type:"default",onClick:_},{default:t(()=>[c(" Reset ")]),_:1})]),_:1})]),_:1},8,["model","rules"]),m("div",pn,I(JSON.stringify(o(s)??{},null,2)),1),m("div",un,[(f(!0),g(S,null,J(o(l),(j,U)=>(f(),g("div",{key:U},I(j),1))),128))])],64)}}}),gn=D(fn,[["__scopeId","data-v-ae2daae2"]]),vn=`<script setup lang="ts">
import OnForm from '@onfl/components/on-form/index.vue';
import type { IValidationMessageWithParams } from '@onfl/types/IValidationRule';
import type { IOnFormExposed } from '@onfl/components/on-form/types';
import type { IValidationField } from '@onfl/types/IValidationField';
