import{_ as B}from"./ApiDoc.vue.BBsrfSvH.js";import{E as v}from"./index.CqeEYO5W.js";import{g,D as p,o as _,c as b,b as n,w as l,u as o,a as m,d as u,t as V,F as x,R as y,a1 as O,W as h,a2 as F,p as I,f as S,_ as w,r as A,a3 as C,n as J,x as U}from"./entry._doioHTx.js";import{u as D}from"./vue.f36acd1f.BVcziSBg.js";const L="OnForm",M="default",k="on-form",H="",q={},W=[{name:"validate"},{name:"validateField"},{name:"resetValidation"}],T=[{name:"model",required:!1,type:{name:"Record",elements:[{name:"string"},{name:"any"}]},defaultValue:{func:!1,value:"() => ({})"}},{name:"layout",required:!1,type:{name:"union",elements:[{name:'"horizontal"'},{name:'"vertical"'}]},defaultValue:{func:!1,value:"'horizontal'"}},{name:"name",required:!1,type:{name:"string"},defaultValue:{func:!1,value:"undefined"}},{name:"rules",required:!1,type:{name:"Record",elements:[{name:"string"},{name:"Array",elements:[{name:"IValidationRule"}]}]},defaultValue:{func:!1,value:"undefined"}},{name:"trigger",required:!1,type:{name:"union",elements:[{name:'"blur"'},{name:'"change"'}]},defaultValue:{func:!1,value:"'blur'"}},{name:"watchRules",required:!1,type:{name:"boolean"}},{name:"touchOnRulesChange",required:!1,type:{name:"boolean"}}],z=[{name:"validate",type:{names:["boolean"]}},{name:"change",type:{names:["Record"],elements:[{name:"string"},{name:"IValidationField"}]}}],P=[{name:"default"}],j="components/on-form/index.vue",G={name:L,exportName:M,displayName:k,description:H,tags:q,expose:W,props:T,events:z,slots:P,sourceFile:j},K=t=>(I("data-v-d361d91b"),t=t(),S(),t),Q={class:"value"},X=K(()=>m("strong",null,"Value:",-1)),Y=g({__name:"basic",setup(t){const e=p({foo:"test",bar:""});return(f,a)=>{const c=y,d=O,s=h,i=F;return _(),b(x,null,[n(i,{model:o(e)},{default:l(()=>[n(d,{name:"foo",label:"Item A"},{default:l(()=>[n(c,{modelValue:o(e).foo,"onUpdate:modelValue":a[0]||(a[0]=r=>o(e).foo=r)},null,8,["modelValue"])]),_:1}),n(d,{name:"bar",label:"Item B"},{default:l(()=>[n(s,{modelValue:o(e).bar,"onUpdate:modelValue":a[1]||(a[1]=r=>o(e).bar=r)},null,8,["modelValue"])]),_:1})]),_:1},8,["model"]),m("div",Q,[X,u(" "+V(JSON.stringify(o(e))),1)])],64)}}}),Z=w(Y,[["__scopeId","data-v-d361d91b"]]),nn=`<script setup lang="ts">
const form = reactive({
  foo: 'test',
  bar: '',
});
...
`,Bn={class:"markdown-body"},An=m("h1",null,"OnForm",-1),Cn=m("h2",null,"Примеры использования",-1),Jn=m("h3",null,"Basic",-1),Un=m("h3",null,"Vertical layout",-1),Dn=m("h3",null,"Hint",-1),Ln=m("h3",null,"Error",-1),Mn=m("h3",null,"Warning",-1),kn=m("h3",null,"Rules",-1),Hn=m("h2",null,"API",-1),Pn="OnForm | OnFrontLib Docs",jn=[{property:"og:title",content:"OnForm | OnFrontLib Docs"},{name:"twitter:title",content:"OnForm | OnFrontLib Docs"}],Gn={__name:"on-form",setup(t,{expose:e}){return e({frontmatter:{title:"OnForm | OnFrontLib Docs",meta:[{property:"og:title",content:"OnForm | OnFrontLib Docs"},{name:"twitter:title",content:"OnForm | OnFrontLib Docs"}]}}),D({title:"OnForm | OnFrontLib Docs",meta:[{property:"og:title",content:"OnForm | OnFrontLib Docs"},{name:"twitter:title",content:"OnForm | OnFrontLib Docs"}]}),(c,d)=>(_(),b("div",Bn,[An,Cn,Jn,n(v,{code:o(nn)},{default:l(()=>[n(Z)]),_:1},8,["code"]),Un,n(v,{code:o(sn)},{default:l(()=>[n(ln)]),_:1},8,["code"]),Dn,n(v,{code:o(fn)},{default:l(()=>[n(un)]),_:1},8,["code"]),Ln,n(v,{code:o(Vn)},{default:l(()=>[n(gn)]),_:1},8,["code"]),Mn,n(v,{code:o(In)},{default:l(()=>[n(Fn)]),_:1},8,["code"]),kn,n(v,{code:o(Nn)},{default:l(()=>[n(Rn)]),_:1},8,["code"]),Hn,n(B,{value:o(G)},null,8,["value"])]))}};export{Gn as default,jn as meta,Pn as title};
