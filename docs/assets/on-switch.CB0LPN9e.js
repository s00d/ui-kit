...
`,x=a=>(y("data-v-d21051d5"),a=a(),w(),a),j={class:"demo"},G={class:"value"},K=x(()=>n("strong",null,"Disabled:",-1)),Q={class:"value"},W=x(()=>n("strong",null,"Readonly:",-1)),X={class:"btn"},Y=g({__name:"disabled",setup(a){const s=h(!1),t=h(!1);return(p,d)=>{const f=m,v=$;return i(),r("div",j,[e(f,{disabled:l(s),readonly:l(t)},null,8,["disabled","readonly"]),n("div",G,[K,o(" "+b(JSON.stringify(l(s))),1)]),n("div",Q,[W,o(" "+b(JSON.stringify(l(t))),1)]),n("div",X,[e(v,{onClick:d[0]||(d[0]=O=>s.value=!l(s))},{default:c(()=>[o(" Toggle disabled ")]),_:1}),e(v,{onClick:d[1]||(d[1]=O=>t.value=!l(t))},{default:c(()=>[o(" Toggle readonly ")]),_:1})])])}}}),Z=_(Y,[["__scopeId","data-v-d21051d5"]]),ee=`<script setup lang="ts">
